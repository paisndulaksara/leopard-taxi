      ...
      <div className="my-container">
        ...
        <div className="mt-6 flex items-center justify-center gap-6">
          <button
            ...
            className="bg-[var(--primary-color)] hover:bg-[var(--secondary-color)] text-white rounded-full p-3 flex items-center justify-center transition transform duration-300 hover:scale-110 hover:-rotate-3"
          >
            <FaChevronLeft />
          </button>
          <button
...
function TestimonialCard({ img, name, text }) {
  return (
    <div className="m-4 p-6 bg-white rounded shadow-sm text-center h-80 flex flex-col justify-between transition transform duration-300 hover:scale-105 hover:shadow-xl">
      {/* Top: Quote icon and text */}
